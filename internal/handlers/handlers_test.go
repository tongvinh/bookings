...
func TestRepository_Reservation(t *testing.T) {
	...
	if rr.Code != http.StatusOK {
		t.Errorf("Reservation handler retured wrong response code: got %d, wanted %d", rr.Code, http.StatusOK)
	}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("Reservation handler retured wrong response code: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
...
func TestRepository_PostReservation(t *testing.T) {
	...
	if rr.Code != http.StatusSeeOther {
		t.Errorf("PostReservation handler retured wrong response code: get %d, wanted %d", rr.Code, http.StatusSeeOther)
	}
